...
declare class NSArray<ObjectType> extends NSObject implements CKRecordValue, NSCopying, NSFastEnumeration, NSMutableCopying, NSSecureCoding {
	...
	static ags_fromJSONClass(jsonArray: NSArray<any> | any[], cls: typeof NSObject): NSArray<any>;
...
declare class NSBlockOperation extends NSOperation implements AGSCancelable {
...
declare class NSDecimalNumber extends NSNumber {
	...
	static ags_valueWithPortalItemType(type: AGSPortalItemType): NSDecimalNumber; // inherited from NSValue
...
declare class NSNumber extends NSValue implements CKRecordValue, NSFetchRequestResult {
	...
	static ags_valueWithPortalItemType(type: AGSPortalItemType): NSNumber; // inherited from NSValue
...
declare class NSValue extends NSObject implements NSCopying, NSSecureCoding {
	...
	static ags_valueWithPortalItemType(type: AGSPortalItemType): NSValue;
	...
	ags_mapServiceImageFormatValue(): AGSMapServiceImageFormat;

	ags_portalItemTypeValue(): AGSPortalItemType;

	ags_relationshipConstraintViolationTypeValue(): AGSRelationshipConstraintViolationType;

	ags_tileImageFormatValue(): AGSTileImageFormat;

	ags_utilityTraceResultTypeValue(): AGSUtilityTraceResultType;
